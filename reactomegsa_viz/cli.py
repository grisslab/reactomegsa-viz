...
def create_report(analysis_id, html_path) -> None:
    ...
    requ = requests.get(f"https://gsa.reactome.org/0.1/result/{analysis_id}")
    ...
    HtmlReportGenerator.create_report(json_result, analysis_id, html_path)
